...
APP_ELFS_MUSL   = $(ISO_ROOT)/bin/musltest.elf $(ISO_ROOT)/bin/stattest.elf $(ISO_ROOT)/bin/dirtest.elf $(ISO_ROOT)/bin/ltsig.elf $(ISO_ROOT)/bin/ltjob.elf $(ISO_ROOT)/bin/ltjob2.elf $(ISO_ROOT)/bin/bash.elf
